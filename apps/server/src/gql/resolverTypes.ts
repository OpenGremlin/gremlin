...
import type { AgentModel } from "./schema/Agent/resolvers.js";
import type { FeedItemModel } from "./schema/Feed/resolvers.js";
import type { NotificationModel } from "./schema/Notification/resolvers.js";
...
export type AgentJobResolvers<
  ContextType = Context,
  ParentType extends
    ResolversParentTypes["AgentJob"] = ResolversParentTypes["AgentJob"],
> = {
...
export type IntegrationResolvers<
  ContextType = Context,
  ParentType extends
    ResolversParentTypes["Integration"] = ResolversParentTypes["Integration"],
> = {
...
> = {
  ...
  dismissNotification?: Resolver<
    Maybe<ResolversTypes["Notification"]>,
    ParentType,
    ContextType,
    RequireFields<MutationDismissNotificationArgs, "id">
  >;
  installSkill?: Resolver<
    Maybe<ResolversTypes["Skill"]>,
    ParentType,
    ContextType,
    RequireFields<MutationInstallSkillArgs, "id">
  >;
  resolveNotification?: Resolver<
    Maybe<ResolversTypes["Notification"]>,
    ParentType,
    ContextType,
    RequireFields<MutationResolveNotificationArgs, "actionId" | "id">
  >;
  togglePermission?: Resolver<
    Maybe<ResolversTypes["Integration"]>,
    ParentType,
    ContextType,
    RequireFields<
      MutationTogglePermissionArgs,
      "enabled" | "integrationId" | "scope"
    >
  >;
  uninstallSkill?: Resolver<
    Maybe<ResolversTypes["Skill"]>,
    ParentType,
    ContextType,
    RequireFields<MutationUninstallSkillArgs, "id">
  >;
  updateAgentStatus?: Resolver<
    Maybe<ResolversTypes["Agent"]>,
    ParentType,
    ContextType,
    RequireFields<MutationUpdateAgentStatusArgs, "id" | "status">
  >;
  updateJobStatus?: Resolver<
    Maybe<ResolversTypes["AgentJob"]>,
    ParentType,
    ContextType,
    RequireFields<MutationUpdateJobStatusArgs, "id" | "status">
  >;
...
> = {
  actions?: Resolver<
    Array<ResolversTypes["NotificationAction"]>,
    ParentType,
    ContextType
  >;
  agent?: Resolver<ResolversTypes["Agent"], ParentType, ContextType>;
...
> = {
  ...
  agentJob?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryAgentJobArgs, "id">
  >;
  agentJobs?: Resolver<
    Array<ResolversTypes["AgentJob"]>,
    ParentType,
    ContextType
  >;
  ...
  feedItem?: Resolver<
    Maybe<ResolversTypes["FeedItem"]>,
    ParentType,
    ContextType,
    RequireFields<QueryFeedItemArgs, "id">
  >;
  feedItems?: Resolver<
  ...
  integration?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryIntegrationArgs, "id">
  >;
  ...
  searchSkills?: Resolver<
    Array<ResolversTypes["Skill"]>,
    ParentType,
    ContextType,
    RequireFields<QuerySearchSkillsArgs, "query">
  >;
  skill?: Resolver<
    Maybe<ResolversTypes["Skill"]>,
    ParentType,
