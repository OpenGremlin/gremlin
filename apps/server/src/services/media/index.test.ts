...
describe("buildMediaUrl", () => {
  ...
  it("adds width query param when provided", () => {
    expect(buildMediaUrl("https://cdn.example.com", "images/photo.png", 300)).toBe(
      "https://cdn.example.com/images/photo.png?width=300",
    );
  });

  it("omits width when null", () => {
    expect(buildMediaUrl("https://cdn.example.com", "images/photo.png", null)).toBe(
      "https://cdn.example.com/images/photo.png",
    );
  });

  it("omits width when undefined", () => {
    expect(buildMediaUrl("https://cdn.example.com", "images/photo.png", undefined)).toBe(
      "https://cdn.example.com/images/photo.png",
    );
  });
