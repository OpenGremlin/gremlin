...
- updateTaskMessage: Post a short progress update. Call this FREQUENTLY — not just at the end. The user sees these messages in real time.
...
IMPORTANT: Call updateTaskMessage at every meaningful step. Keep messages SHORT — under 10 words.
Examples: "Brainstorming characters", "Writing first draft", "Polishing final version", "Done — 1,200 words"
