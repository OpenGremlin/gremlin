  ...
  return (
    <div className="absolute top-0 left-0 right-0 z-10 flex flex-col">
      {hasTask && (
        <Link
          to={`/agents/${agent.id}`}
          className="flex items-center px-2 py-2 overflow-hidden hover:brightness-125"
          style={{
            background: `
      ...
      <Link
        ...
        className="pt-3 pb-3 flex flex-col items-center border-b border-neutral-800/60 bg-neutral-950/70 backdrop-blur-md hover:bg-neutral-900/50 transition-colors"
      >
