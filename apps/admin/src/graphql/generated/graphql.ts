...
export type AgentUpdatedSubscription = {
  __typename?: "Subscription";
  agentUpdated: {
    __typename?: "Agent";
    id: string;
...
export type ConnectApiKeyMutation = {
  __typename?: "Mutation";
...
export type RenameConnectionMutation = {
  __typename?: "Mutation";
  renameIntegrationConnection: boolean;
};
...
export type RevokeConnectionMutation = {
  __typename?: "Mutation";
  revokeIntegrationConnection: boolean;
};
...
export type SetDefaultModelMutation = {
  __typename?: "Mutation";
  setDefaultModel: boolean;
};

export type BedrockEnabledModelsQueryVariables = Exact<{
  [key: string]: never;
}>;

export type BedrockEnabledModelsQuery = {
  __typename?: "Query";
  bedrockEnabledModels: Array<string>;
};
...
export type EnableBedrockModelMutation = {
  __typename?: "Mutation";
  enableBedrockModel: boolean;
};
...
export type DisableBedrockModelMutation = {
  __typename?: "Mutation";
  disableBedrockModel: boolean;
};

export type AgentJobsQueryVariables = Exact<{ [key: string]: never }>;

export type AgentJobsQuery = {
  __typename?: "Query";
  agentJobs: Array<{
    __typename?: "AgentJob";
    id: string;
...
export type AgentJobQuery = {
  ...
  agentJob?: {
    ...
    lastRun?: string | null;
    nextRun?: string | null;
    agent: { __typename?: "Agent"; id: string; name: string };
    tasks: Array<{
      __typename?: "Task";
      id: string;
      title: string;
...
export type InstallSkillMutation = {
  __typename?: "Mutation";
  installSkill?: {
    __typename?: "Skill";
    id: string;
...
export type UninstallSkillMutation = {
  __typename?: "Mutation";
  uninstallSkill?: {
    __typename?: "Skill";
    id: string;
...
export type TaskLogCreatedSubscription = {
  __typename?: "Subscription";
  taskLogCreated: {
    __typename?: "AgentLog";
    id: string;
...
export const AgentLogCreatedDocument = new TypedDocumentString(`
  ...
  AgentLogCreatedSubscriptionVariables
>;
...
export const AgentUpdatedDocument = new TypedDocumentString(`
  ...
  AgentUpdatedSubscriptionVariables
>;
...
export const IntegrationProvidersDocument = new TypedDocumentString(`
  ...
  IntegrationProvidersQueryVariables
>;
export const IntegrationConnectionsDocument = new TypedDocumentString(`
  ...
  IntegrationConnectionsQueryVariables
>;
...
export const ConnectApiKeyDocument = new TypedDocumentString(`
  ...
  ConnectApiKeyMutationVariables
>;
export const RenameConnectionDocument = new TypedDocumentString(`
  ...
  RenameConnectionMutationVariables
>;
export const RevokeConnectionDocument = new TypedDocumentString(`
  ...
  RevokeConnectionMutationVariables
>;
export const SetDefaultModelDocument = new TypedDocumentString(`
  ...
  SetDefaultModelMutationVariables
>;
...
export const EnableBedrockModelDocument = new TypedDocumentString(`
  ...
  EnableBedrockModelMutationVariables
>;
...
export const UpdateAgentJobDocument = new TypedDocumentString(`
  ...
  UpdateAgentJobMutationVariables
>;
...
export const UninstallSkillDocument = new TypedDocumentString(`
  ...
  UninstallSkillMutationVariables
>;
...
export const TaskLogCreatedDocument = new TypedDocumentString(`
  ...
  TaskLogCreatedSubscriptionVariables
>;
