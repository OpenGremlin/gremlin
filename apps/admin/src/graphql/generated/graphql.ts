...
export type TogglePermissionMutation = { __typename?: 'Mutation', togglePermission?: { __typename?: 'Integration', id: string, service: string, icon: string, description: string, account: string, connectedAt: string, authMethod: AuthMethod, permissions: Array<{ __typename?: 'Permission', scope: string, label: string, enabled: boolean }> } | null };

export type AgentJobsQueryVariables = Exact<{ [key: string]: never; }>;


export type AgentJobsQuery = { __typename?: 'Query', agentJobs: Array<{ __typename?: 'AgentJob', id: string, name: string, description: string, recurrence: string, cronExpression?: string | null, status: JobStatus, lastRun?: string | null, nextRun?: string | null, agent: { __typename?: 'Agent', id: string } }> };
...
export type AgentJobQuery = { __typename?: 'Query', agentJob?: { __typename?: 'AgentJob', id: string, name: string, description: string, recurrence: string, cronExpression?: string | null, status: JobStatus, lastRun?: string | null, nextRun?: string | null, agent: { __typename?: 'Agent', id: string, name: string }, tasks: Array<{ __typename?: 'Task', id: string, title: string, status: TaskStatus, createdAt: string, agent: { __typename?: 'Agent', id: string } }> } | null };
...
export type UpdateAgentJobMutation = { __typename?: 'Mutation', updateAgentJob?: { __typename?: 'AgentJob', id: string, name: string, description: string, recurrence: string, cronExpression?: string | null, status: JobStatus, lastRun?: string | null, nextRun?: string | null, agent: { __typename?: 'Agent', id: string } } | null };
...
export type TaskQuery = { __typename?: 'Query', task?: { __typename?: 'Task', id: string, title: string, status: TaskStatus, message?: string | null, createdAt: string, updatedAt: string, completedAt?: string | null, artifacts: Array<string>, agent: { __typename?: 'Agent', id: string }, documents: Array<{ __typename?: 'Document', id: string, title: string, body: string, createdAt: string, updatedAt: string }>, logs: { __typename?: 'AgentLogConnection', edges: Array<{ __typename?: 'AgentLogEdge', node: { __typename?: 'AgentLog', id: string, role: AgentLogRole, content: string, toolName?: string | null, toolInput?: string | null, toolResult?: string | null, taskId?: string | null, createdAt: string } }>, pageInfo: { __typename?: 'AgentLogPageInfo', hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: string | null, endCursor?: string | null } } } | null };
