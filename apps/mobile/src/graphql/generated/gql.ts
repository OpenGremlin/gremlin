...
type Documents = {
    ...
    "\n  query GetBead($id: ID!) {\n    bead(id: $id) {\n      id\n      title\n      status\n      assignee\n      assigneeName\n      parentId\n      latestComment\n      children {\n        id\n        title\n        status\n        assignee\n        assigneeName\n        latestComment\n      }\n    }\n  }\n": typeof types.GetBeadDocument,
    "\n  subscription BeadUpdated($id: ID!) {\n    beadUpdated(id: $id) {\n      id\n      title\n      status\n      assignee\n      assigneeName\n      parentId\n      latestComment\n      children {\n        id\n        title\n        status\n        assignee\n        assigneeName\n        latestComment\n      }\n    }\n  }\n": typeof types.BeadUpdatedDocument,
...
const documents: Documents = {
    ...
    "\n  mutation AttachFileReference($input: AttachFileReferenceInput!) {\n    attachFileReference(input: $input)\n  }\n": types.AttachFileReferenceDocument,
    "\n  mutation ClearAgentLog($agentId: ID!, $taskId: String) {\n    clearAgentLog(agentId: $agentId, taskId: $taskId) {\n      clearedAt\n    }\n  }\n": types.ClearAgentLogDocument,
    ...
    "\n  query GetBead($id: ID!) {\n    bead(id: $id) {\n      id\n      title\n      status\n      assignee\n      assigneeName\n      parentId\n      latestComment\n      children {\n        id\n        title\n        status\n        assignee\n        assigneeName\n        latestComment\n      }\n    }\n  }\n": types.GetBeadDocument,
    "\n  subscription BeadUpdated($id: ID!) {\n    beadUpdated(id: $id) {\n      id\n      title\n      status\n      assignee\n      assigneeName\n      parentId\n      latestComment\n      children {\n        id\n        title\n        status\n        assignee\n        assigneeName\n        latestComment\n      }\n    }\n  }\n": types.BeadUpdatedDocument,
