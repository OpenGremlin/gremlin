...
export type PostSummaryFragment = { __typename?: 'Post', id: string, taskId: string, title: string, message: string, createdAt: string, agent?: { __typename?: 'Agent', id: string, name: string, role?: string | null, delegationHint?: string | null, retired: boolean, voiceEnabled: boolean } | null, attachments: Array<
    | { __typename?: 'FileAttachment', file?: { __typename?: 'File', path: string, name: string, sizeBytes: number, mimeType?: string | null, modifiedAt: string, fileType: FileType, render:
          | { __typename: 'AudioRender', url: string, durationSeconds?: number | null }
          | { __typename: 'CodeRender', content: string, language: string }
          | { __typename: 'DocumentRender', markdown: string, title?: string | null }
...
export type PostQuery = { __typename?: 'Query', post?: { __typename?: 'Post', id: string, taskId: string, title: string, message: string, createdAt: string, agent?: { __typename?: 'Agent', id: string, name: string, role?: string | null, delegationHint?: string | null, retired: boolean, voiceEnabled: boolean } | null, attachments: Array<
      | { __typename?: 'FileAttachment', file?: { __typename?: 'File', path: string, name: string, sizeBytes: number, mimeType?: string | null, modifiedAt: string, fileType: FileType, render:
            | { __typename: 'AudioRender', url: string, durationSeconds?: number | null }
            | { __typename: 'CodeRender', content: string, language: string }
            | { __typename: 'DocumentRender', markdown: string, title?: string | null }
...
export type PostsQuery = { __typename?: 'Query', posts: { __typename?: 'PostConnection', edges: Array<{ __typename?: 'PostEdge', cursor: string, node: { __typename?: 'Post', id: string, taskId: string, title: string, message: string, createdAt: string, agent?: { __typename?: 'Agent', id: string, name: string, role?: string | null, delegationHint?: string | null, retired: boolean, voiceEnabled: boolean } | null, attachments: Array<
          | { __typename?: 'FileAttachment', file?: { __typename?: 'File', path: string, name: string, sizeBytes: number, mimeType?: string | null, modifiedAt: string, fileType: FileType, render:
                | { __typename: 'AudioRender', url: string, durationSeconds?: number | null }
                | { __typename: 'CodeRender', content: string, language: string }
                | { __typename: 'DocumentRender', markdown: string, title?: string | null }
...
export type PostCreatedSubscription = { __typename?: 'Subscription', postCreated: { __typename?: 'Post', id: string, taskId: string, title: string, message: string, createdAt: string, agent?: { __typename?: 'Agent', id: string, name: string, role?: string | null, delegationHint?: string | null, retired: boolean, voiceEnabled: boolean } | null, attachments: Array<
      | { __typename?: 'FileAttachment', file?: { __typename?: 'File', path: string, name: string, sizeBytes: number, mimeType?: string | null, modifiedAt: string, fileType: FileType, render:
            | { __typename: 'AudioRender', url: string, durationSeconds?: number | null }
            | { __typename: 'CodeRender', content: string, language: string }
            | { __typename: 'DocumentRender', markdown: string, title?: string | null }
