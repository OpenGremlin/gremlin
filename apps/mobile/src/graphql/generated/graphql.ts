...
export type TaskSummaryFragment = { __typename?: 'Task', id: string, title: string, message?: string | null, createdAt: string, emoji?: string | null, agent: { __typename?: 'Agent', id: string, name: string, personality?: string | null, retired: boolean }, files: Array<{ __typename?: 'File', path: string, name: string, sizeBytes: number, mimeType?: string | null, modifiedAt: string, render:
      | { __typename: 'AudioRender', url?: string | null, durationSeconds?: number | null }
      | { __typename: 'CodeRender', content: string, language: string }
      | { __typename: 'DocumentRender', markdown: string, title?: string | null }
      | { __typename: 'ImageRender', url?: string | null, width?: number | null, height?: number | null, aspectRatio?: number | null, fullUrl?: string | null }
...
export type TasksQuery = { __typename?: 'Query', tasks: { __typename?: 'TaskConnection', edges: Array<{ __typename?: 'TaskEdge', cursor: string, node: { __typename?: 'Task', id: string, title: string, message?: string | null, createdAt: string, emoji?: string | null, agent: { __typename?: 'Agent', id: string, name: string, personality?: string | null, retired: boolean }, files: Array<{ __typename?: 'File', path: string, name: string, sizeBytes: number, mimeType?: string | null, modifiedAt: string, render:
            | { __typename: 'AudioRender', url?: string | null, durationSeconds?: number | null }
            | { __typename: 'CodeRender', content: string, language: string }
            | { __typename: 'DocumentRender', markdown: string, title?: string | null }
            | { __typename: 'ImageRender', url?: string | null, width?: number | null, height?: number | null, aspectRatio?: number | null, fullUrl?: string | null }
