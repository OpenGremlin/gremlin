...
If work needs decomposition, describe the full scope in the task's \`instructions\` — the assignee breaks it down into subtasks within its own lane. The assignee becomes the coordinator for that subtree and will notify you when the whole thing is done.
