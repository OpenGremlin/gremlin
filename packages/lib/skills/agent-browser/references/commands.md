...
agent-browser --profile <path> ...    # Persistent Chrome profile directory
agent-browser --state <path> ...      # Load state file at launch
agent-browser --session-name <name>   # Auto-save/restore session by name
agent-browser --executable-path <p>   # Custom browser executable
agent-browser --extension <path> ...  # Load browser extension (repeatable)
agent-browser --color-scheme dark     # Force dark mode
agent-browser --ignore-https-errors   # Ignore SSL certificate errors
agent-browser --download-path <dir>   # Set default download directory
agent-browser --content-boundaries    # Wrap page output in markers for AI safety
...
AGENT_BROWSER_COLOR_SCHEME=dark              # Force color scheme
AGENT_BROWSER_DEFAULT_TIMEOUT=25000          # Default timeout (ms)
AGENT_BROWSER_MAX_OUTPUT=50000               # Max output size
AGENT_BROWSER_IDLE_TIMEOUT_MS=60000          # Auto-shutdown after inactivity
AGENT_BROWSER_ENCRYPTION_KEY="hex..."        # Encrypt state files at rest
AGENT_BROWSER_ALLOWED_DOMAINS="example.com"  # Domain allowlist
AGENT_BROWSER_ACTION_POLICY="./policy.json"  # Action policy file
AGENT_BROWSER_CONTENT_BOUNDARIES=1           # Enable content boundary markers
